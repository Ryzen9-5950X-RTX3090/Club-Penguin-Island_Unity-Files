			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4.xyz = u_xlat1.xyz + (-_Centre.xyz);
					    u_xlat0.x = max(u_xlat0.x, 0.0);
					    u_xlat0.xyz = u_xlat0.xxx * u_xlat4.xyz + _Centre.xyz;
					    ...
					    u_xlat0.xyz = u_xlat0.xxx + vec3(vec3(_GreySaturate, _GreySaturate, _GreySaturate));
