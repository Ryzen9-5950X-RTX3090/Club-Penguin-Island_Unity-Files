		...
		Pass {
			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlatb0 = in_TEXCOORD0.x<0.499000013;
					    u_xlat2.xy = (bool(u_xlatb0)) ? vec2(0.0, -0.0) : vec2(1.0, -0.5);
					    vs_TEXCOORD1.x = u_xlatb0 ? 1.0 : float(0.0);
					    u_xlat0.x = u_xlat2.y + in_TEXCOORD0.x;
					    vs_TEXCOORD1.y = u_xlat2.x;
					    u_xlat0.x = max(u_xlat0.x, 0.0);
					    vs_TEXCOORD0.x = u_xlat0.x + u_xlat0.x;
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_EmojiTex, vs_TEXCOORD0.xy);
					    u_xlat0 = u_xlat0 * vs_TEXCOORD1.yyyy;
