			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.x = cos(_Decal1RotationRads);
					    u_xlat3.z = u_xlat1.x;
					    u_xlat3.y = u_xlat2.x;
					    u_xlat3.x = (-u_xlat1.x);
					    u_xlat10.xy = in_TEXCOORD0.xy + (-vec2(_AtlasOffsetU, _AtlasOffsetV));
					    u_xlat10.xy = u_xlat10.xy / vec2(_AtlasOffsetScaleU, _AtlasOffsetScaleV);
					    u_xlat1.xy = u_xlat0.xy + u_xlat10.xy;
					    ...
					    u_xlat0.x = sin(_Decal2RotationRads);
					    u_xlat1.x = cos(_Decal2RotationRads);
					    u_xlat2.z = u_xlat0.x;
					    u_xlat6.xy = vec2(_Decal2UOffset, _Decal2VOffset) + vec2(-0.5, -0.5);
					    u_xlat3.xy = u_xlat10.xy + u_xlat6.xy;
					    u_xlat2.y = u_xlat1.x;
					    u_xlat2.x = (-u_xlat0.x);
					    u_xlat0.y = dot(u_xlat3.xy, u_xlat2.xy);
					    u_xlat0.x = dot(u_xlat3.xy, u_xlat2.yz);
					    ...
					    u_xlat1.xy = u_xlat0.xy + u_xlat10.xy;
					    u_xlat2.x = sin(_Decal3RotationRads);
					    u_xlat3.x = cos(_Decal3RotationRads);
					    u_xlat4.z = u_xlat2.x;
					    u_xlat4.y = u_xlat3.x;
					    u_xlat4.x = (-u_xlat2.x);
					    u_xlat11.y = dot(u_xlat1.xy, u_xlat4.xy);
					    u_xlat11.x = dot(u_xlat1.xy, u_xlat4.yz);
					    u_xlat0.xy = (-u_xlat0.xy) + u_xlat11.xy;
					    ...
					    u_xlat1.xy = u_xlat0.xy + u_xlat10.xy;
					    u_xlat2.x = sin(_Decal4RotationRads);
					    u_xlat3.x = cos(_Decal4RotationRads);
					    u_xlat4.z = u_xlat2.x;
					    u_xlat4.y = u_xlat3.x;
					    u_xlat4.x = (-u_xlat2.x);
					    ...
					    u_xlat1.xy = u_xlat0.xy + u_xlat10.xy;
					    u_xlat2.x = sin(_Decal5RotationRads);
					    u_xlat3.x = cos(_Decal5RotationRads);
					    u_xlat4.z = u_xlat2.x;
					    u_xlat4.y = u_xlat3.x;
					    u_xlat4.x = (-u_xlat2.x);
					    u_xlat11.y = dot(u_xlat1.xy, u_xlat4.xy);
					    ...
					    u_xlat2.x = cos(_Decal6RotationRads);
					    u_xlat3.z = u_xlat1.x;
					    u_xlat3.y = u_xlat2.x;
					    u_xlat3.x = (-u_xlat1.x);
					    u_xlat1.y = dot(u_xlat10.xy, u_xlat3.xy);
					    u_xlat1.x = dot(u_xlat10.xy, u_xlat3.yz);
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = phase0_Input0_1 + vec4(-0.5, -0.5, -0.5, -0.5);
					    u_xlat2 = u_xlat2 + u_xlat2;
					    u_xlat1.xy = max(abs(u_xlat2.yw), abs(u_xlat2.xz));
					    u_xlat13 = _Decal1Repeat * 255.0 + 1.0;
					    u_xlatb1.y = u_xlat13>=u_xlat1.y;
					    u_xlatb1.x = 1.0>=u_xlat1.x;
					    u_xlat1.x = u_xlatb1.x ? float(1.0) : 0.0;
					    u_xlat1.y = u_xlatb1.y ? float(1.0) : 0.0;
					;
					    u_xlat2 = texture(_Decal1Tex, phase0_Input0_1.zw);
					    u_xlat2 = u_xlat1.yyyy * u_xlat2;
					    u_xlat2.xyz = u_xlat2.xyz * _Decal1Color.xyz;
					    u_xlat7.x = _Decal2Repeat * 255.0 + 1.0;
					    u_xlatb6 = u_xlat7.x>=u_xlat0.y;
					    u_xlat6 = u_xlatb6 ? 1.0 : float(0.0);
					    u_xlat3 = texture(_Decal2Tex, phase0_Input0_2.xy);
					    u_xlat3 = vec4(u_xlat6) * u_xlat3;
					    u_xlat3.xyz = u_xlat3.xyz * _Decal2Color.xyz;
					    u_xlat4 = texture(_Decal123OpacityTex, phase0_Input0_1.xy);
					    u_xlat6 = u_xlat3.w * u_xlat4.y;
					    u_xlat3.xyz = vec3(u_xlat6) * u_xlat3.xyz;
					    u_xlat6 = u_xlat1.w * u_xlat4.z + u_xlat6;
					    u_xlat7.x = u_xlat1.w * u_xlat4.z;
					    u_xlat6 = u_xlat2.w * u_xlat4.x + u_xlat6;
					    u_xlat13 = u_xlat2.w * u_xlat4.x;
					    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat13) + u_xlat3.xyz;
					    u_xlat0.xzw = u_xlat0.xzw * u_xlat7.xxx + u_xlat2.xyz;
					    u_xlat6 = min(u_xlat6, 1.0);
					    u_xlat2 = phase0_Input0_3.zwxy + vec4(-0.5, -0.5, -0.5, -0.5);
					    u_xlat2 = u_xlat2 + u_xlat2;
					    u_xlat7.xy = max(abs(u_xlat2.yw), abs(u_xlat2.xz));
					    u_xlat19 = _Decal5Repeat * 255.0 + 1.0;
					    u_xlatb7 = u_xlat19>=u_xlat7.x;
					    u_xlat7.x = u_xlatb7 ? 1.0 : float(0.0);
					    u_xlat2 = texture(_Decal5Tex, phase0_Input0_3.zw);
					    u_xlat2 = u_xlat7.xxxx * u_xlat2;
					    u_xlat7.x = u_xlat4.y * u_xlat2.w;
					    u_xlat2.xyz = u_xlat2.xyz * _Decal5Color.xyz;
					    u_xlat3.xy = vs_TEXCOORD6.xy + vec2(-0.5, -0.5);
					    u_xlat3.xy = u_xlat3.xy + u_xlat3.xy;
					    u_xlat19 = max(abs(u_xlat3.y), abs(u_xlat3.x));
					    u_xlat20 = _Decal6Repeat * 255.0 + 1.0;
					    u_xlatb19 = u_xlat20>=u_xlat19;
					    u_xlat19 = u_xlatb19 ? 1.0 : float(0.0);
					    u_xlat3 = texture(_Decal6Tex, vs_TEXCOORD6.xy);
					    u_xlat3 = vec4(u_xlat19) * u_xlat3;
					    u_xlat19 = (-u_xlat3.w) * u_xlat4.z + 1.0;
					    u_xlat20 = (-u_xlat7.x) * u_xlat19 + 1.0;
					    u_xlat7.x = u_xlat19 * u_xlat7.x;
					    u_xlat10 = _Decal4Repeat * 255.0 + 1.0;
					    u_xlatb13 = u_xlat10>=u_xlat7.y;
					    u_xlat13 = u_xlatb13 ? 1.0 : float(0.0);
					    u_xlat5 = texture(_Decal4Tex, phase0_Input0_3.xy);
					    u_xlat5 = vec4(u_xlat13) * u_xlat5;
					    u_xlat13 = u_xlat4.x * u_xlat5.w;
					    u_xlat4.xyw = u_xlat5.xyz * _Decal4Color.xyz;
					    u_xlat13 = u_xlat20 * u_xlat13;
					    u_xlat20 = u_xlat3.w * u_xlat4.z + u_xlat7.x;
					    u_xlat2.xyz = u_xlat7.xxx * u_xlat2.xyz;
					    u_xlat7.x = u_xlat4.z * u_xlat3.w;
					    u_xlat3.xyz = u_xlat3.xyz * _Decal6Color.xyz;
					    u_xlat20 = u_xlat13 * u_xlat19 + u_xlat20;
					    u_xlat13 = u_xlat19 * u_xlat13;
					    u_xlat2.xyz = u_xlat4.xyw * vec3(u_xlat13) + u_xlat2.xyz;
					    u_xlat7.xyz = u_xlat3.xyz * u_xlat7.xxx + u_xlat2.xyz;
					    u_xlat2.x = min(u_xlat20, 1.0);
					    u_xlat8 = (-u_xlat2.x) + 1.0;
					    u_xlat0.xzw = u_xlat0.xzw * vec3(u_xlat8);
					    u_xlat0.xzw = u_xlat7.xyz * u_xlat2.xxx + u_xlat0.xzw;
					    u_xlat6 = u_xlat6 + u_xlat2.x;
					    u_xlat6 = min(u_xlat6, 1.0);
					    u_xlat0.xzw = vec3(u_xlat6) * u_xlat0.xzw;
					    u_xlat6 = (-u_xlat6) + 1.0;
					    u_xlat2 = texture(_Diffuse, phase0_Input0_1.xy);
			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = unity_MatrixVP[2] * u_xlat0.zzzz + u_xlat1;
					    gl_Position = unity_MatrixVP[3] * u_xlat0.wwww + u_xlat1;
					    u_xlat0.x = in_TEXCOORD0.x + (-_AtlasOffsetU);
					    vs_TEXCOORD0.x = u_xlat0.x / _AtlasOffsetScaleU;
					    u_xlat0.x = in_TEXCOORD0.y + (-_AtlasOffsetV);
					    vs_TEXCOORD0.y = u_xlat0.x / _AtlasOffsetScaleV;
					    return;
					}"
				}
			}
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.x = u_xlatb0 ? 1.0 : float(0.0);
					    u_xlat1 = texture(_BodyColorsMaskTex, vs_TEXCOORD0.xy);
					    u_xlat3.xyz = u_xlat1.yyy * _BodyGreenChannelColor.xyz;
					    u_xlat3.xyz = u_xlat1.xxx * _BodyRedChannelColor.xyz + u_xlat3.xyz;
					    u_xlat2.xyz = u_xlat1.zzz * _BodyBlueChannelColor.xyz + u_xlat3.xyz;
					    u_xlat3.x = max(u_xlat1.y, u_xlat1.x);
					    u_xlat2.w = max(u_xlat1.z, u_xlat3.x);
			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xy = in_TEXCOORD0.xy + (-vec2(_AtlasOffsetU, _AtlasOffsetV));
					    vs_TEXCOORD0.xy = u_xlat1.xy / vec2(_AtlasOffsetScaleU, _AtlasOffsetScaleV);
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4 = u_xlatb0.x ? 1.0 : float(0.0);
					    u_xlat1 = texture(_DetailAndMatcapMaskAndEmissive, vs_TEXCOORD0.xy);
					    u_xlatb0.z = 127.0<u_xlat1.z;
					    u_xlat12 = u_xlatb0.z ? 1.0 : float(0.0);
					    u_xlat0.x = (u_xlatb0.x) ? float(0.0) : float(1.0);
					    u_xlat0.z = (u_xlatb0.z) ? float(0.0) : float(1.0);
					    u_xlat13 = u_xlat1.z * 0.5 + 0.5;
					    u_xlat12 = u_xlat12 * u_xlat13;
					    u_xlat5 = (-u_xlat1.y) * 0.5 + 0.5;
					    u_xlat2.w = u_xlat5 * u_xlat0.z + u_xlat12;
					    u_xlat3.xyz = u_xlat1.zzz * _EmissiveColorTint.xyz;
					    u_xlat3.xyz = u_xlat3.xyz + u_xlat3.xyz;
					    u_xlat8 = (-u_xlat1.z) + 1.0;
					    u_xlat2.xyz = u_xlat1.xxx * vec3(u_xlat8) + u_xlat3.xyz;
					    SV_Target0 = u_xlat2 * vec4(u_xlat4) + u_xlat0.xxxx;
					    return;
					}"
				}
			}
