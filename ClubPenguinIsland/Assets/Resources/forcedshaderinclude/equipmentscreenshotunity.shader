Shader "CpRemix/Equipment Screenshot" {
	Properties {
		...
		_ScreenshotBGColor ("Screenshot Background Color", Vector) = (0.03,0.03,0.03,1)
	}
	SubShader {
		Pass {
			GpuProgramID 48317
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat9 = u_xlat0.x + u_xlat0.z;
					    u_xlat9 = u_xlat0.y + u_xlat9;
					    u_xlatb9 = 0.300000012<u_xlat9;
					    u_xlat10 = u_xlatb9 ? 1.0 : float(0.0);
					    u_xlat9 = (u_xlatb9) ? 0.0 : 1.0;
					    u_xlat2.xyz = vec3(u_xlat10) * _BodyRedChannelColor.xyz;
					    SV_Target0.xyz = u_xlat1.xyz * vec3(u_xlat9) + u_xlat2.xyz;
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.xyz = u_xlat0.xyw * u_xlat1.xxx + u_xlat3.xyz;
					    u_xlat1 = texture(_BodyColorsMaskTex, vs_TEXCOORD0.xy);
					    u_xlat6 = u_xlat1.x + u_xlat1.z;
					    u_xlat6 = u_xlat1.y + u_xlat6;
					    u_xlatb6 = 0.300000012<u_xlat6;
					    u_xlat1.x = u_xlatb6 ? 1.0 : float(0.0);
					    u_xlat6 = (u_xlatb6) ? 0.0 : 1.0;
					    SV_Target0.xyz = u_xlat0.xyz * vec3(u_xlat6) + u_xlat1.xxx;
					    SV_Target0.w = 1.0;
					    return;
					}"
				}
